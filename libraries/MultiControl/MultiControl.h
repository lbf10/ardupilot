...
#define MOMENTS_OF_INERTIA_DEFAULT AP_Vector3f(0.3143978800, 0.3122127800, 0.5557912400)
#define PRODUCTS_OF_INERTIA_DEFAULT AP_Vector3f(0.0000861200, -0.0014397600, 0.0002368800)
#define MAIN_TRANSLATIONAL_FRICTION_DEFAULT AP_Vector3f(0.25, 0.25, 0.25)
...
#define ROTOR1_POSITION_DEFAULT AP_Vector3f(0.34374, 0.34245, 0.0143)
#define ROTOR2_POSITION_DEFAULT AP_Vector3f(-0.341, 0.34213, 0.0143)
#define ROTOR3_POSITION_DEFAULT AP_Vector3f(-0.34068, -0.34262, 0.0143)
#define ROTOR4_POSITION_DEFAULT AP_Vector3f(0.34407, -0.34229, 0.0143)
#define ROTOR5_POSITION_DEFAULT AP_Vector3f(0.33898, 0.33769, 0.0913)
#define ROTOR6_POSITION_DEFAULT AP_Vector3f(-0.33624, 0.33736, 0.0913)
#define ROTOR7_POSITION_DEFAULT AP_Vector3f(-0.33591, -0.33785, 0.0913)
#define ROTOR8_POSITION_DEFAULT AP_Vector3f(0.3393, -0.33753, 0.0913)

#define ROTOR1_ORIENTATION_DEFAULT AP_Vector3f(-0.061628417, -0.061628417, 0.996194698)
#define ROTOR2_ORIENTATION_DEFAULT AP_Vector3f(0.061628417, -0.061628417, 0.996194698)
#define ROTOR3_ORIENTATION_DEFAULT AP_Vector3f(0.061628417, 0.061628417, 0.996194698)
#define ROTOR4_ORIENTATION_DEFAULT AP_Vector3f(-0.061628417, 0.061628417, 0.996194698)
#define ROTOR5_ORIENTATION_DEFAULT AP_Vector3f(-0.061628417, -0.061628417, 0.996194698)
#define ROTOR6_ORIENTATION_DEFAULT AP_Vector3f(0.061628417, -0.061628417, 0.996194698)
#define ROTOR7_ORIENTATION_DEFAULT AP_Vector3f(0.061628417, 0.061628417, 0.996194698)
#define ROTOR8_ORIENTATION_DEFAULT AP_Vector3f(-0.061628417, 0.061628417, 0.996194698)
